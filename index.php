...
<html>
<head>
<title>Inscription Sucre d'Orge</title>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="#" method="post">
					<input class="text" type="text" name="name" placeholder="Prénom" required="">
					...
					<input class="text w3lpass" type="password" name="password" placeholder="Confirmation de mot de passe" required="">
