...
<body class="bg-danger">
    ...
    <button type="button" class="btn btn-light pull-right"><a href="../controller/disconect.php">Déconnexion</a></button>
        ...
        <?php      
                ...
                <strong class="center">Vous avez déjà envoyer un message.</strong> 
                ...
                <div class="typing-message row">
                    <div class="col-9">
                        <div class="input-group mb-3 center justify-content-left">
                            <input type="text" name="receiver" class="TxtName" id="inputName"  onkeyup='callSearch(this.value)' placeholder="Votre destinataire"  aria-label="Recipient's username" aria-describedby="basic-addon2">
